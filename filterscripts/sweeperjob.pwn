	...
	if(GetVehicleModel(GetPlayerVehicleID(playerid)) == 574)
	 {
	    if (IsPlayerInRangeOfPoint(playerid, 7.0,sweperpoint1))
	    {
			...
			GameTextForPlayer(playerid, "~g~Bersih!", 3000, 3);
		}
        ...
        if (IsPlayerInRangeOfPoint(playerid, 7.0,sweperpoint12))
        {
    		 ...
    		 GameTextForPlayer(playerid, "~g~Kau di upah $3000", 3000, 3);
      		 SendClientMessage(playerid, COLOR_RED, ""GR"[KERJA]:"WH" Kau Telah Menyelesaikan Pekerjaanmu! Kau Diupah{33FF33} 3000$");
             DisablePlayerCheckpoint(playerid);
  	...
  	if(GetVehicleModel(GetPlayerVehicleID(playerid)) == 574)
   	{
   	    ...
   	    GameTextForPlayer(playerid, "~g~Kau sekarang menjadi pembersih jalan", 3000, 3);
